...
```typescript
const naveen = {
  role: "AI Engineer — Voice & Conversational AI",
  focus: ["LLM-powered voice agents", "Agentic AI workflows", "Speech interfaces"],
  domains: ["Healthcare", "Insurance", "Travel & Hospitality", "IAM"],
  languages: ["Java", "TypeScript", "JavaScript", "Groovy", "Python"],
  currentlyLearning: ["System Design", "DSA", "ML foundations"],
  funFact: "I debug conversations, not just code — down to the SIP layer 📞",
};
```

- 🔭 Building **enterprise voice AI agents** — LLM-driven dialog, STT/ASR tuning, telephony & EHR integrations
- 🧠 Deep in **prompt engineering, LLM guardrails, entity extraction, and agentic workflows**
- 🌱 Open-sourcing the voice AI patterns I keep rebuilding — see the toolkit below
- 💬 Ask me about **Voice AI · STT/ASR · LLMs · Java · Spring Boot · Angular/React · Microservices · DevOps**
- 📄 Resume & projects: **[naveenkumars.in](https://naveenkumars.in)**
- 📫 Reach me: **naveenkumar59835@gmail.com**

---

## 🔧 Open-Source Voice AI Toolkit

> TypeScript libraries distilled from real production voice-agent problems. MIT licensed · tested.

| Library | What it does |
|---|---|
| 🗣️ **[stt-normalize](https://github.com/naveenkumarans/stt-normalize)** | Turns messy speech-to-text into clean data — spoken digits ("oh", "double five"), phone numbers, ZIP codes, spoken dates, filler stripping |
| 🛡️ **[voice-guardrails](https://github.com/naveenkumarans/voice-guardrails)** | Runtime guardrails for LLM voice agents — persona-leak detection, duplicate-response suppression, TTS-safe sanitization |
| 🎯 **[asr-boost-gen](https://github.com/naveenkumarans/asr-boost-gen)** | Weighted ASR boost-phrase configs — golden-set merging, override precedence, dedupe, engine phrase caps |
| ☎️ **[dtmf-capture](https://github.com/naveenkumarans/dtmf-capture)** | Deterministic DTMF digit-capture state machine for IVR — timeouts, terminator keys, validators. Born from fixing a 44% capture-failure rate |
...
<p>
  ...
  <img src="https://img.shields.io/badge/Microservices-2E4E79?style=for-the-badge" alt="Microservices"/>
...
<p>
  ...
  <img src="https://img.shields.io/badge/MS_SQL_Server-CC2927?style=for-the-badge" alt="MS SQL Server"/>
...
<p align="center">
  <img src="https://github-readme-stats-fast.vercel.app/api?username=naveenkumarans&show_icons=true&hide_title=true&theme=transparent" alt="GitHub stats"/>
</p>

## 🔥 Contribution Streak

<p align="center">
  <img src="https://github-readme-stats-fast.vercel.app/api/streak?username=naveenkumarans&theme=transparent" alt="Streak"/>
</p>

## 🧩 Most Used Languages

<p align="center">
  <img src="https://github-readme-stats-fast.vercel.app/api/top-langs/?username=naveenkumarans&layout=compact&theme=transparent" alt="Top languages"/>
</p>

## 📈 Activity Graph

<p align="center">
  <img src="https://github-readme-activity-graph.vercel.app/graph?username=naveenkumarans&theme=github" alt="Activity graph"/>
</p>
...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&height=120&color=gradient&customColorList=6,12,20&section=footer" alt="footer wave"/>
